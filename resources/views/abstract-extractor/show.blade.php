...
<div class="container box">
    ...
    <h1>AbstractExtractor {{ $abstractextractor->id }}
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            <tbody>
                <tr>
                    <th>ID</th><td>{{ $abstractextractor->id }}</td>
                </tr>
                <tr><th> Property </th><td> {{ $abstractextractor->property }} </td></tr><tr><th> Priority </th><td> {{ $abstractextractor->priority }} </td></tr><tr><th> Enabled </th><td> {{ $abstractextractor->enabled }} </td></tr>
            </tbody>
        </table>
    </div>
